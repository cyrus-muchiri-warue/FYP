          ...
          <div class="card card-primary">
            ...
            <div class="form-group">
                ...
                <select name="project_id" id="chapter" class="form-control custom-select">
                  <option selected="" value="{{$file->project->id}}">{{$file->project->name}}</option>
              ...
              <div class="form-group">
                <label for="chapter">select one</label>
                <select name="chapter" id="chapter" class="form-control custom-select">
                  <option selected="" disabled="">{{$file->name}}</option>
              ...
              <div class="form-group">
                ...
                <input name="name" type="file" id="file" value='{{$file->name}}')}} >
              </div>
